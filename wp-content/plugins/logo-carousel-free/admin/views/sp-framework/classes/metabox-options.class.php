		...
		<div class="lc_shortcode text-center">
			...
			<div class="lc-col-lg-6">
				<div class="lc_shortcode_content">
					...
					<div class="shortcode-wrap">
					<div class="lc-after-copy-text"><i class="fa fa-check-circle"></i> <?php _e( 'Shortcode  Copied to Clipboard! ', 'logo-carousel-free' ); ?>  </div>
						<div class="lc-sc-code selectable">&lt;?php echo do_shortcode('[logocarousel id="<?php echo $post->ID; ?>"]'); ?&gt;</div>
						</div>
				</div>
			</div>
		</div>
			...
			if ( $has_nav ) {
				...
				foreach ( $this->sections as $section ) {
					...
					echo '<li><a href="#" data-section="' . esc_attr( $this->unique . '_' . $tab_key ) . '" class="' . esc_attr( $this->unique . '_' . $tab_key ) . '">' . $tab_icon . $section['title'] . $tab_error . '</a></li>';
