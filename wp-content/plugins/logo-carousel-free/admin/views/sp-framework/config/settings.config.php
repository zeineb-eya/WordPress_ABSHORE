	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'help'    => __( 'Check this box if you would like Logo Carousel to completely remove all of its data when the plugin is deleted.', 'logo-carousel-free' ),
				'default' => false,
			),
			array(
			...
			array(
				...
				// 'desc'    => __( 'On/off the switch to enqueue/dequeue fontawesome css.', 'logo-carousel-free' ),
				'default'    => true,
			...
			array(
				...
				// 'desc'    => __( 'On/off the switch to enqueue/dequeue slick css.', 'logo-carousel-free' ),
				'default'    => true,
				'text_on'    => __( 'Enqueue', 'logo-carousel-free' ),
				'text_off'   => __( 'Dequeue', 'logo-carousel-free' ),
				'text_width' => 95,
			...
			array(
				...
				// 'desc'    => __( 'On/off the switch to enqueue/dequeue remodal js.', 'logo-carousel-free' ),
				'default'    => true,
				'text_on'    => __( 'Enqueue', 'logo-carousel-free' ),
				'text_off'   => __( 'Dequeue', 'logo-carousel-free' ),
				'text_width' => 95,
	...
	array(
		...
		'fields' => array(
			...
			array(
				...
				'title'    => __( 'Custom CSS', 'logo-carousel-free' ),
				// 'desc'     => __( 'Type your custom css.', 'logo-carousel-free' ),
			),
		),
	)
);
