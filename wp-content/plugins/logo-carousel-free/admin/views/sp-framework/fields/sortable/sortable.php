 ...
 *
 */
if ( ! class_exists( 'SPLC_FREE_Field_sortable' ) ) {
  class SPLC_FREE_Field_sortable extends SPLC_FREE_Fields {
    ...
    public function render() {
      ...
      echo '<div class="splogocarousel-sortable" data-depend-id="'. esc_attr( $this->field['id'] ) .'">';
      ...
      foreach ( $pre_sortby as $key => $field ) {
        ...
        echo '<div class="splogocarousel-sortable-item">';

          echo '<div class="splogocarousel-sortable-content">';
          ...
          SPLC::field( $field, $field_value, $unique_id, 'field/sortable' );

          echo '</div>';

          echo '<div class="splogocarousel-sortable-helper"><i class="fas fa-arrows-alt"></i></div>';
