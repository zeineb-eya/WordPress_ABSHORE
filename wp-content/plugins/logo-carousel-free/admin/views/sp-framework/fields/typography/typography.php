	...
	class SPLC_FREE_Field_typography extends SPLC_FREE_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_family'] ) ) {
				...
				echo $this->create_select( array( $this->value['font-family'] => $this->value['font-family'] ), 'font-family', esc_html__( 'Select a font', 'logo-carousel-free' ) );
				echo '</div>';
			}
			...
			if ( ! empty( $args['font_weight'] ) || ! empty( $args['font_style'] ) ) {
				...
				echo '<option disabled value="">' . ( ! $this->chosen ? esc_html__( 'Default', 'logo-carousel-free' ) : '' ) . '</option>';
			...
			if ( ! empty( $args['subset'] ) ) {
				...
				echo $this->create_select( $subset, 'subset', esc_html__( 'Default', 'logo-carousel-free' ), $args['multi_subset'] );
				echo '</div>';
			}
			...
			if ( ! empty( $args['color'] ) ) {
				...
				echo '<input disabled type="text" name="' . esc_attr( $this->field_name( '[color]' ) ) . '" class="splogocarousel-color splogocarousel--color" value="' . esc_attr( $this->value['color'] ) . '"' . $default_color_attr . ' />';
				echo '</div>';
				echo '</div>';
			}
