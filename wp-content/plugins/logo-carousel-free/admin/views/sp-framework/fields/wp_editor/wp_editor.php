...
if ( ! class_exists( 'SPLC_FREE_Field_wp_editor' ) ) {
  class SPLC_FREE_Field_wp_editor extends SPLC_FREE_Fields {
    ...
    public function render() {
      ...
      echo ( splogocarousel_wp_editor_api() ) ? '<div class="splogocarousel-wp-editor" data-editor-settings="'. esc_attr( json_encode( $editor_settings ) ) .'">' : '';
    ...
    public function setup_wp_editor_media_buttons() {
      ...
      echo 'var splogocarousel_media_buttons = '. json_encode( $media_buttons ) .';';
      echo '</script>';
    ...
    public function setup_wp_editor_settings() {
      ...
      if ( splogocarousel_wp_editor_api() && class_exists( '_WP_Editors') ) {
        ...
        $defaults = apply_filters( 'splogocarousel_wp_editor', array(
          'tinymce' => array(
            'wp_skip_init' => true
          ),
        ) );
