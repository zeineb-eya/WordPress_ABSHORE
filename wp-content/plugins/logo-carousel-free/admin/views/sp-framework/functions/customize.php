 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Panel_SPLC' ) && class_exists( 'WP_Customize_Panel' ) ) {
	class WP_Customize_Panel_SPLC extends WP_Customize_Panel {
		public $type = 'splogocarousel';
	}
}
 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Section_SPLC' ) && class_exists( 'WP_Customize_Section' ) ) {
	class WP_Customize_Section_SPLC extends WP_Customize_Section {
		public $type = 'splogocarousel';
	}
}
 ...
 * @version 1.0.0
 */
if ( ! class_exists( 'WP_Customize_Control_SPLC' ) && class_exists( 'WP_Customize_Control' ) ) {
	class WP_Customize_Control_SPLC extends WP_Customize_Control {
		...
		public function render() {
			...
			if ( ! empty( $this->field['dependency'] ) ) {
				...
				$visible  = ' splogocarousel-dependency-control';
		...
		public function render_field_content() {
			...
			$complex = apply_filters(
				'splogocarousel_customize_complex_fields',
				array(
					'accordion',
					'background',
					'border',
			...
			$class      = ( $is_complex || $custom ) ? ' splogocarousel-customize-complex' : '';
			...
			echo '<div class="splogocarousel-customize-field' . esc_attr( $class ) . '"' . $atts . '>';

			SPLC::field( $this->field, $this->value(), $this->unique, 'customize' );
