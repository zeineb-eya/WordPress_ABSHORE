				...
				<div class="row">
					<div class="sp-lc__col-xl-6">
						<div class="sp-lc__banner-content">
							<h2 class="sp-lc__font-30 main-color sp-lc__font-weight-500"><?php _e( 'Upgrade To Logo Carousel Pro', 'logo-carousel-free' ); ?></h2>
							<h4 class="sp-lc__mt-10 sp-lc__font-18 sp-lc__font-weight-500"><?php _e( 'Multi-Use Responsive Logo Showcase Plugin for WordPress', 'logo-carousel-free' ); ?></h4>
							<p class="sp-lc__mt-25 text-color-2 line-height-20 sp-lc__font-weight-400"><?php _e( 'Display a list of clients, sponsors, partners, affiliates, supporters, suppliers, brands logos on your WordPress website.', 'logo-carousel-free' ); ?></p>
							<p class="sp-lc__mt-20 text-color-2 sp-lc__line-height-20 sp-lc__font-weight-400"><?php _e( 'Create a <strong>Carousel, Grid, Isotope Filter, List, and Inline</strong> view of logo images with Title, Description, Read more, Tooltips, Links (Internal or External) and Popup, etc.', 'logo-carousel-free' ); ?></p>
						</div>
					...
					<div class="sp-lc__col-xl-6">
						<div class="sp-lc__banner-img">
							<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/lc-vector.svg'; ?>" alt="">
						</div>
					</div>
				</div>
			</div>
		...
		<section class="sp-lc__video">
			<div class="sp-lc__container">
				...
				<div class="video-area text-center">
					<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/lc-vector-2.svg'; ?>" alt="">
			...
			<div class="sp-lc__container">
				...
				<div class="feature-wrapper">
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/layouts.svg'; ?>" alt="">
							</div>
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="
								<?php echo SP_LC_URL . 'admin/assets/css/images/premium/design-without-writing-CSS.svg'; ?>
								" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="
								<?php echo SP_LC_URL . 'admin/assets/css/images/premium/drag-and-drop.svg'; ?>
								" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/link.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/group-and-specific.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/filter.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/live-filter.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/carousel-controls.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/carousel-mode.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/multiple-row.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/popup.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/modern-effects.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/advanced-settings.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/translation-ready.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
					...
					<div class="feature-area">
						<div class="feature-item mr-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/page-builders.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
						...
						<div class="feature-item ml-30">
							<div class="feature-icon">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/support.svg'; ?>" alt="">
							</div>
							<div class="feature-content">
			...
			<div class="sp-lc__container">
				<div class="row">
					<div class="sp-lc__col-xl-12">
						...
						<div class="buy_img">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/premium/happy-user.svg'; ?>" alt="">
							</div>
		...
		<div class="row">
				<div class="col-lg-6">
					<div class="testimonial-area">
						...
						<div class="testimonial-info">
							<div class="img">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/Mark-Kolodziej-min.png'; ?>" alt="">
							</div>
							<div class="info">
				...
				<div class="col-lg-6">
					<div class="testimonial-area">
						...
						<div class="testimonial-info">
							<div class="img">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/Daniel-Powney-min.png'; ?>" alt="">
							</div>
							<div class="info">
								<h3>Daniel Powney</h3>
	...
	public function help_page_callback() {
		...
		<div class="sp-logo-carousel-help-page">
					...
					<div class="header-area">
						<div class="container">
							<div class="header-logo">
								<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/lc-logo.svg'; ?>" alt="">
								<span><?php echo SP_LC_VERSION; ?></span>
							</div>
				...
				<section class="sp-lc-help upgrade">
					...
					<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/lc-icon1.svg'; ?>" alt="">
					</div>
							...
							<div class="row">
								<div class="col-lg-6">
									<ul class="upgrade-list">
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Display a list of clients, sponsors, partners, affiliates, supporters, suppliers, brands logo images on your WordPress site.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">
										5 Logo Layout Presets (Carousel, Grid, Isotope Filter, List, and Inline view)</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">200+ Advanced Styling and Layout Customization Options.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Drag & Drop Custom logo ordering.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Display Group (Category) and Specific Logo.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Logo Internal & External Logo links.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Category-wise Logo Filtering (Isotope Layout).</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt=""> Live Category Filter (Opacity).</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Logo Effects on Hover. (Grayscale, zoom in & out, blur, opacity, etc.)</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Multiple Rows in the Carousel.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Carousel Mode. (Standard, Ticker, Center).</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Supports both Vertical and Horizontal directions.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Set Logo Title Positions (Top, bottom, middle, on hover, etc.)</li>
									</ul>
								</div>
								<div class="col-lg-6">
									<ul class="upgrade-list">
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">25+ Logo Carousel Controls.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Logo Display with Tooltips, Title, Description, and CTA button(Read more).</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Tooltips Settings. (Show/hide, Position, Width, Effects, Background, etc.)</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Popup View for Logo Detail.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Logo Background, Hover, Border, Radius, BoxShadow Highlight, etc.</li>								
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Set Logo margin between logos and inner padding.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Select logo vertical alignment type (Top, middle & bottom).</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">840+ Google Fonts (Advanced Typography).</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Advanced Plugin Settings.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Multisite, Multilingual, RTL, Accessibility ready.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Page Builders & Countless Theme Compatibility.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt="">Top-notch Support and Frequently Updates.</li>
										<li><img src="<?php echo SP_LC_URL . 'admin/assets/css/images/checkmark.svg'; ?>" alt=""><span>Not Happy? 100% No Questions Asked <a href="//shapedplugin.com/refund-policy/" target="_blank">Refund Policy!</a></span></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="container">
						<div class="upgrade-pro">
							<div class="pro-content">
								<div class="pro-icon">
									<img src="<?php echo SP_LC_URL . 'admin/assets/css/images/lc-icon.svg'; ?>" alt="">
								</div>
								<div class="pro-text">
