	...
	class SP_Logo_Carousel {
		...
		function add_shortcode_form( $column, $post_id ) {
			...
			switch ( $column ) {
				...
				case 'shortcode':
					$column_field = '<div class="lc-after-copy-text"><i class="fa fa-check-circle"></i> ' . __( 'Shortcode  Copied to Clipboard! ', 'logo-carousel-free' ) . '</div><input class="lc_input_shortcode"  style="width: 210px;padding: 6px; cursor:pointer;" type="text" onClick="this.select();" readonly="readonly" value="[logocarousel ' . 'id=&quot;' . $post_id . '&quot;' . ']"/>';
					echo $column_field;
					break;
				default:
					break;
