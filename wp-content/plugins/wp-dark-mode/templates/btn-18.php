...
<div class="style-18 <?php echo 'yes' == $floating  ? 'floating' : ''; ?> <?php echo ! empty( $position ) ? $position : ''; ?>
 <?php echo apply_filters( 'wp_dark_mode/switch_label_class', 'wp-dark-mode-side-toggle-wrap wp-dark-mode-ignore' ); ?>">
    ...
    <div class="wp-dark-mode-side-toggle wp-dark-mode-toggle wp-dark-mode-switcher wp-dark-mode-ignore">
        ...
        <svg class="wp-dark-mode-ignore mode-light" xmlns="http://www.w3.org/2000/svg" width="32" height="18.215" viewBox="0 0 32 18.215">
        ...
        <svg class="wp-dark-mode-ignore mode-dark" xmlns="http://www.w3.org/2000/svg" width="32" height="18.215" viewBox="0 0 32 18.215">
